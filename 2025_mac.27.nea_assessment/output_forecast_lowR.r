...
R <- rectable(fit)[,1]
R <- R[as.character(2017:(ay))]      ### carefull here : that is the alternative pessimistic option
...
write.csv(options , file = "./output/catchoptions_lowR.csv") 
