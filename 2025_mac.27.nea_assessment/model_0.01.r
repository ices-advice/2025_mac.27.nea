...
R <- cbind(2024-0:6, 2025-0:6, 2025-0:6, 2023-0:6, 2025-0:6,2023-0:6)
ret<-stockassessment::retro(fit, year=R)     

R <- cbind(2024-0:4, 2025-0:4, 2025-0:4, 2023-0:4, 2025-0:4,2023-0:4)
...
save(fit, lo,ret,ret5peels,dat,par,conf,res,RES,RESP,file=paste0("model/fit_and_diagnostics/model_",modName,"_full_output.RData"))
